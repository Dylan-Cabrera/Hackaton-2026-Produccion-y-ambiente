...
// HU-07 adaptado: este backend no trackea búsquedas (eso era del backend viejo
// que sacamos), así que el dashboard se arma con lo que sí existe de verdad:
// clics de contacto por producto, y necesidades abiertas de tu mismo rubro.
export default function ProducerDemandPage() {
  ...
  if (status !== "authenticated" || loading || !summary) {
    return (
