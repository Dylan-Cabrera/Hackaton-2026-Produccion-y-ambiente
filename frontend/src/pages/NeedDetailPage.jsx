...
export default function NeedDetailPage() {
  ...
  const authorName = authorDisplayName(need.author);
  const message = `Hola ${authorName}, vi en la plataforma que necesitás ${need.quantity} ${need.unit} de ${need.title}. ¿Podría proveerlo?`;
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <p className="text-muted-foreground">
            Publicado por <strong className="text-foreground">{authorName}</strong>
            {need.author.locality && ` · ${need.author.locality}`}
          </p>
          ...
          {isAuthor ? (
            ...
            <p className="text-muted-foreground">
              Iniciá sesión como productor para ver los datos de contacto.
            </p>
          )}
        </CardContent>
      </Card>
